...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-15 (commit 1fc8912). Confidence: 65%.
...
### Code health
Three co-equal signals: defect risk 9.94/10 avg, hotspot health 9.94/10 (stable), worst `server.py` at 7.1/10 · maintainability 9.92/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
