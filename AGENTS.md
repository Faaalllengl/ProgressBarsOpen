...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-21 (commit c3f57bc). Confidence: 72%.
...
### Code health
Three co-equal signals: defect risk 8.71/10 avg, hotspot health 10.0/10 (stable), worst `server.py` at 2.46/10 · maintainability 9.09/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
