...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-25 (commit f70e6d6). Confidence: 72%.
...
- `road-progress.html` — 14 commits/90d
- `road-progress-data.json` — 6 commits/90d
- `.repowise/knowledge-graph.json` — 3 commits/90d
- `server.py` — 8 commits/90d

### Code health
Three co-equal signals: defect risk 9.21/10 avg, hotspot health 9.15/10 (stable), worst `server.py` at 5.26/10 · maintainability 9.12/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
