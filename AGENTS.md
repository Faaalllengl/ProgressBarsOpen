...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-25 (commit 4204387). Confidence: 72%.
...
### Code health
Three co-equal signals: defect risk 6.55/10 avg, hotspot health 6.5/10 (stable), worst `server.py` at 5.26/10 · maintainability 9.12/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
